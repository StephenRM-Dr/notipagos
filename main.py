...
<div class="container" style="max-width:480px; margin-top:30px;">
    ...
    <div class="card" style="text-align:center;">
        ...
        <div style="margin-top:25px; padding:20px; border-radius:15px; text-align:left; border-left: 5px solid;" class="{{ resultado.clase }}">
            ...
            {% if resultado.datos %}
                <p><b>De:</b> {{ resultado.datos[0] }}<br><b>Monto:</b> {{ resultado.datos[1] }}<br><b>Ref:</b> {{ resultado.datos[3] }}</p>
            {% endif %}
        </div>
        <audio id="audioStatus" autoplay>
            <source src="{{ 'https://assets.mixkit.co/active_storage/sfx/2000/2000-preview.mp3' if resultado.clase == 'success' else 'https://assets.mixkit.co/active_storage/sfx/2014/2014-preview.mp3' }}" type="audio/mpeg">
        </audio>
        {% endif %}
    </div>
</div>
